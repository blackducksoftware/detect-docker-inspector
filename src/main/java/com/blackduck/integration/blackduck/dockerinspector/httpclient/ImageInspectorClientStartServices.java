...
public class ImageInspectorClientStartServices extends ImageInspectorClient {
    ...
    private ContainerDetails ensureServiceReady(IntHttpClient httpClient, URI imageInspectorUri, ImageInspectorOsEnum inspectorOs) throws IntegrationException, InterruptedException, IOException {
